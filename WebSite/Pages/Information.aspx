            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                        <h2 style="color:#31849B; font-weight:bold">CẬP NHẬT THÔNG TIN</h2>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:TextBox ID="txtMobilePhone" CssClass="form-control" runat="server" ReadOnly="True"></asp:TextBox>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="row text-center">
                                <asp:Button ID="btnUpdate" class="btn btn-lg" runat="server" ValidationGroup="Data" Text="Lưu lại" OnClick="btnUpdate_Click" BackColor="#31849B" BorderColor="#31849B" ForeColor="White" />
                                <asp:Button ID="btnCancel" class="btn btn-lg" runat="server" ValidationGroup="Data" Text="Hủy" OnClick="btnCancel_Click" BackColor="#31849B" BorderColor="#31849B" ForeColor="White"/>
                            </div>
                        </div>
                    </div>
