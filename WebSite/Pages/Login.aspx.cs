...
public partial class Pages_Login : System.Web.UI.Page
{
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        if (IsValid)
        {
            System.Data.DataTable dt = BUS.tblMemberCard.Login(txtUserName.Text.Trim(), txtUserName.Text.Trim(), txtPassword.Text);
            lbError.Text = "";
            if (dt.Rows.Count > 0)
            {
            ...
            {
                lbError.Text = "Mã thẻ, email không tồn tại hoặc mật khẩu không chính xác";
            }
        }
    }
