...
<asp:Content ID="Content2" ContentPlaceHolderID="clhContent" runat="Server">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <br />
            <br />
            <div style="color: #31849B" class="page-header">
                <h2 style="font-weight: bold">HỆ THỐNG DÀNH CHO NHÂN VIÊN </h2>
            </div>
            <div style="color: #31849B" class="modal-body table-responsive=text-right">
            ...
            <section class="login-form">
                <div class="formlogin">
                    ...
                    <div class="page-header">
                        <h2 style="color: #31849B">Đăng nhập</h2>
                        <h4 style="color: #31849B">Hệ thống quản trị</h4>
