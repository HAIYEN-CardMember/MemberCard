...
<asp:Content ID="Content2" ContentPlaceHolderID="clhContent" runat="Server">
    <div class="row">
        <div class="page-header text-center">
            <h2 style="color: #31849B"><B>QUẢN LÝ LUẬT TÍNH ĐIỂM</B></h2>
        </div>
        ...
        <div class="col-sm-12">
            <asp:GridView ID="gvData" runat="server" CssClass="table table-hover table-striped table-bordered" GridLines="None" AutoGenerateColumns="False" HeaderStyle-CssClass="text-center"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Điều luật" HeaderStyle-CssClass="text-center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Chức năng" HeaderStyle-CssClass="text-center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Điểm tăng/giảm" HeaderStyle-CssClass="text-center">
                        <ItemTemplate>
        ...
        <div class="form-group form-group-sm">
            <div class="col-sm-offset-3 col-sm-6">
                <div class="col-sm-6">
                    <asp:Button ID="btnAdd" class="btn btn-lg btn-block" runat="server" Text="Thêm luật" OnClick="btnAdd_Click" BackColor="#31849B" BorderColor="#31849B" ForeColor="White"/>
                </div>
                <div class="col-sm-6">
