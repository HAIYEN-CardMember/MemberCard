<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage/MasterPageMemberCard.master" AutoEventWireup="true" CodeFile="ReportIncrease_Decrease_2.aspx.cs" Inherits="Administrator_Pages_MemberCard_ReportIncrease_Decrease" %>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
            <asp:GridView ID="gvData" runat="server" CssClass="table table-hover table-striped table-bordered" GridLines="None" AutoGenerateColumns="False" HeaderStyle-CssClass="text-center"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PaymentAtName" HeaderText="Đổi điểm tại" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-left" />
                    ...
                    <asp:BoundField DataField="ServiceAmount" HeaderText="Giá trị" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" DataFormatString="{0:N0}" />
                    <asp:BoundField DataField="MAT304" HeaderText="Hitec304" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" DataFormatString="{0:N0}"/>
                    <asp:BoundField DataField="MATHYEC" HeaderText="HYEC" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" DataFormatString="{0:N0}"/>
                    <asp:BoundField DataField="MATANSINH" HeaderText="HitecAS" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-center" DataFormatString="{0:N0}" />
                </Columns>
