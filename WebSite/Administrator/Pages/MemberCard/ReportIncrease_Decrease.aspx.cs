...
public partial class Administrator_Pages_MemberCard_ReportIncrease_Decrease : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        gvData.DataSource = BUS.tblMemberCardServiceTransaction.GetViewShare(s, e);
        gvData.DataBind();
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        System.Data.DataTable dt = BUS.tblMemberCardServiceTransaction.GetViewShare(sta, end);
        dt.Columns.Remove("ID");
        dt.Columns.Remove("SharePlaceID");
        dt.Columns.Remove("PaymentAtID");
        //dt.Columns["No_"].ColumnName = "STT";
        dt.Columns["Card_ID"].ColumnName = "Mã thẻ";
        ...
        dt.Columns["SharePlaceName"].ColumnName = "Cùng chi trả";
        dt.Columns["ShareAmount"].ColumnName = "Giá trị";
