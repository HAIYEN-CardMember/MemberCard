<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/MasterPage/MasterPageMemberCard.master" AutoEventWireup="true" CodeFile="ReportServiceTransaction.aspx.cs" Inherits="Administrator_Pages_MemberCard_ReportServiceTransaction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="clhContent" runat="Server">
    <div class="row">
        <div class="page-header text-center">
            <h2 style="color: #31849B"><B>BÁO CÁO TỔNG SỐ GIAO DỊCH</B></h2>
        </div>
