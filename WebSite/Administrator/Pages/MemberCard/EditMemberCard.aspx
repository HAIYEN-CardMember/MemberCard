            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <div class=" col-xs-12 col-sm-12 col-md-12  col- col-lg-12 text-center">
                        <h2 style="color: #31849B">
                            <b><asp:Label ID="lbTitle" runat="server" Text=""></asp:Label></h2></b>
                    </div>
                </div>
            </div>
            <div class=" col-xs-12 col-sm-12 col-md-12  col- col-lg-12">
                <div class="form-horizontal">
                    <div class="form-group form-group-sm">
                        <h4><b style="color: #31849B">Thông tin khách hàng:</b></h4>
                    </div>
                    <div class="form-group form-group-sm">
                    ...
                    <div class="form-group form-group-sm">
                        <h4><b style="color: #31849B">Thông tin thẻ:</b></h4>
                    </div>
                    <div class="form-group form-group-sm">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-lg-4">
                            <div class="col-lg-12">
                                <asp:LinkButton ID="lbReset" runat="server" OnClick="lbReset_Click" OnClientClick='return confirm("Bạn có muốn cập nhật mật khẩu này không ?");'>Cấp lại mật khẩu</asp:LinkButton>
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-lg-10">
                            <div class="col-lg-12">
                                <asp:DropDownList ID="ddlIssuePlace_ID" CssClass="form-control" runat="server" Enabled="False"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-lg-4">
                            <div class="col-lg-12">
                                <asp:DropDownList ID="ddlEMRPlace_ID" CssClass="form-control" runat="server" Visible="True"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                    ...
                    <div class="form-group form-group-sm">
                        <div class="col-lg-offset-3 col-lg-6">
                            <div class="col-lg-6">
                                <asp:Button ID="btnEdit" class="btn btn-lg btn-block" runat="server" ValidationGroup="Data" Text="Cập nhật" BackColor="#31849B" BorderColor="#31849B" ForeColor="White" OnClick="btnEdit_Click" OnClientClick='return confirm("Bạn có muốn cập nhật lại thông tin không ?");' />
                            </div>
                            <div class="col-lg-6">
