                ...
                <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <h2 style="color: #31849B">
                            <b><asp:Label ID="lbTitle" runat="server" Text=""></asp:Label></b></h2>
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="form-horizontal">
                    <div class="form-group form-group-sm">
                        <h4><b class="col-sm-4" style="color: #31849B">Thông tin khách hàng:</b></h4>
                    </div>
                    <div class="form-group form-group-sm">
                    ...
                    <div class="form-group form-group-sm">
                        <h4><b class="col-sm-4" style="color: #31849B">Thông tin thẻ:</b></h4> 
                    </div>
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-sm-4">
                            <div class="col-sm-12">
                                ...
                                <asp:TextBox ID="txtCard_Code" CssClass="form-control" placeholder="Bỏ trống để tạo tự động" runat="server" ReadOnly="True"></asp:TextBox>
                    ...
                    <div class="form-group form-group-sm">
                        <div class="col-sm-offset-3 col-sm-6">
                            <div class="col-sm-4">
                                <asp:Button ID="btnAdd" class="btn btn-lg btn-block" runat="server" ValidationGroup="Data" Text="Mở thẻ" OnClick="btnAdd_Click" BackColor="#31849B" BorderColor="#31849B" ForeColor="White" />
                            </div>
                            <div class="col-sm-4">
