...
<asp:Content ID="Content2" ContentPlaceHolderID="clhContent" Runat="Server">
    <div class="row">
        <div class="page-header text-center">
            <h2 style="color: #31849B"><B>SỬA LUẬT TÍNH ĐIỂM</B></h2>
                    ...
                    <div class="form-group form-group-sm">
                     ...
                     <div class="form-group form-group-sm">
                        <div class="col-lg-offset-3 col-lg-6">
                            <div class="col-lg-4">
                                <asp:Button ID="btnEdit" class="btn btn-lg btn-block" runat="server" ValidationGroup="Data" Text="Cập nhật" OnClick="btnEdit_Click" BackColor="#31849B" BorderColor="#31849B" ForeColor="White"  />
                            </div>
                            
                            <div class="col-lg-4">
                                <asp:Button ID="btnDelete" class="btn btn-lg btn-block" runat="server" BackColor="#31849B" BorderColor="#31849B" ForeColor="White" ValidationGroup="Data" Text="Xóa" OnClick="btnDelete_Click" OnClientClick='return confirm("Bạn có muốn xóa rule không?");'/>
                            </div>
                            <div class="col-lg-4">
