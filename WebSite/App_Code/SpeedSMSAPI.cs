...
namespace SpeedSMSAPI
{
    class SpeedSMSAPI
    {
        ...
        public String sendSMS(String[] phones, String content, int type, String sender, String campaign_name)
        {
            ...
            builder += "], \"content\": \"" + content + "\", \"type\":" + type + ", \"sender\": \"" + sender + "\", \"campaign_name\": \"" + campaign_name + "\"}";
            String json = builder.ToString();
            return client.UploadString(url, json);
        }
        public String sendSMS(String phone, String content, int type, String sender, String campaign_name)
        {
            String url = rootURL + "/sms/send";
            if (phone.Length <= 0)
                return "";
            ...
            string builder = "{\"to\":[\"" + phone + "\"], \"content\": \"" + content + "\", \"type\":" + type + ", \"sender\": \"" + sender + "\", \"campaign_name\": \"" + campaign_name + "\"}";
            String json = builder.ToString();
            return client.UploadString(url, json);
        }
    }
