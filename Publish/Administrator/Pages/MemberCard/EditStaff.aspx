...
<asp:Content ID="Content2" ContentPlaceHolderID="clhContent" runat="Server">
    ...
    <div class="row">
        <div class="page-header text-center">
            <h2 style="color: #2d5c8a">Chỉnh sửa thông tin nhân viên</h2>
        ...
        <div class="col-sm-12">
            <div class="form-horizontal">
                <div class="form-group form-group-sm">
                    <b class="col-sm-2" style="color: #2d5c8a">Thông tin nhân viên:</b>
                </div>
                <div class="form-group form-group-sm">
                ...
                <div class="form-group form-group-sm">
                    <div class="col-sm-offset-3 col-sm-6">
                        ...
                        <div class="col-sm-4">
                            <asp:Button ID="btnDelete" class="btn btn-lg btn-primary btn-block" runat="server" ValidationGroup="Data" Text="Xóa nhân viên" OnClick="btnDelete_Click" OnClientClick='return confirm("Bạn có muốn xóa nhân viên không?");' />
                        </div>
