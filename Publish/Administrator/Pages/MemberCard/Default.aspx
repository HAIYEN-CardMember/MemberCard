...
<asp:Content ID="Content2" ContentPlaceHolderID="clhContent" runat="Server">
    <div class="row">
        <div class="page-header text-center">
            <h2 style="color: #2d5c8a">Hệ thống quản lý thẻ</h2>
        </div>
        <div class="form-horizontal">
            <div class="form-group-sm">
                ...
                <div class="col-xs-2">
                    <asp:TextBox ID="txtMaHoSo" CssClass="form-control" placeholder="Mã hồ sơ" runat="server"></asp:TextBox>
                </div>
                <div class="col-xs-2">
                    <asp:Button ID="btnSearch" CssClass="btn form-control" runat="server" Text="Search" OnClick="btnSearch_Click" BackColor="#2d5c8a" BorderColor="#2d5c8a" ForeColor="White" />
                </div>
                <div class="col-xs-2">
                    <asp:Button ID="btnClear" CssClass="btn form-control" runat="server" Text="Clear" OnClick="btnClear_Click" BackColor="#2d5c8a" BorderColor="#2d5c8a" ForeColor="White" />
                </div>
                <div class="col-xs-2">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
            <asp:GridView ID="gvData" runat="server" CssClass="table table-hover table-striped table-bordered" GridLines="None" AutoGenerateColumns="False" HeaderStyle-CssClass="text-center"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tổng điểm tích lũy" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-right">
                        <ItemTemplate>
                            <%if (((Administrator_MasterPage_MasterPageMemberCard)Master).mPermission.UPDServiceTransaction.View)
                              {
                            %>
