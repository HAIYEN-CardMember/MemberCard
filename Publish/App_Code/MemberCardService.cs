...
public class MemberCardService : System.Web.Services.WebService
{
    ...
    public int AddMemberCardAndCustomer(string Card_Code, int CardType_ID, DateTime IssueDate, int IssuePlace_ID, string IssueBy, DateTime ExpDate, int Status_ID, int TotalPoint, string AccessCode, string EMRCode, int EMRPlace_ID, string Notes, string FullName, int Gender_ID, DateTime DOB, int YOB, string AddressLine1, string AddressLine2, string MobilePhone, string Phone2, string Email)
    {
        ...
        if (string.IsNullOrEmpty(memberCard.Card_Code) || BUS.tblMemberCard.GetByCardCode(memberCard.Card_Code) == null)
        {
            if (BUS.tblCustomer.Create(customer) > -1)
            {
                ...
                if (memberCard.Card_ID > 0)
                {
                    ...
                    common.SendNotifyCreatedByCardID(memberCard.Card_ID, AccessCode);
    ...
    public bool DeleteMemberCardAndCustomer(int card_ID)
    {
        if (!(AuthenticationInfo.Username == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoUsername"] && AuthenticationInfo.Password == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoPassword"]))
            throw new System.Security.Authentication.AuthenticationException();
        ...
        {
            BUS.tblCustomer.Delete(memberCard.Customer_ID);
            BUS.tblServiceTransaction.DeleteByCard_ID(memberCard.Card_ID);
    ...
    [SoapHeader("AuthenticationInfo", Required = true)]
    public int AddServiceTransaction(int Card_ID, DateTime ServiceDate, int ServicePlace_ID, string ServiceDescription, int ServiceAmount, int Increase_Decrease, bool AutoTransferInput, int PointRule_ID, int PointRec)
    {
        if (!(AuthenticationInfo.Username == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoUsername"] && AuthenticationInfo.Password == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoPassword"]))
            throw new System.Security.Authentication.AuthenticationException();
        ...
        int result = 0;
        if (BUS.tblServiceTransaction.Create(item) > 0) // add transaction success
        {
    ...
    [SoapHeader("AuthenticationInfo", Required = true)]
    public bool DeleteServiceTransactionByCardID(int ID)
    {
        if (!(AuthenticationInfo.Username == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoUsername"] && AuthenticationInfo.Password == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoPassword"]))
            throw new System.Security.Authentication.AuthenticationException();
        return BUS.tblServiceTransaction.DeleteByCard_ID(ID) > 0;
    }
    ...
    [SoapHeader("AuthenticationInfo", Required = true)]
    public bool DeleteServiceTransactionByID(int ID)
    {
        if (!(AuthenticationInfo.Username == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoUsername"] && AuthenticationInfo.Password == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoPassword"]))
            throw new System.Security.Authentication.AuthenticationException();
        return BUS.tblServiceTransaction.Delete(ID) > 0;
    }
    ...
    public bool UpdateMemberCard(int card_ID, int cardType_ID, int customer_ID, DateTime issueDate, int issuePlace_ID, string issueBy, DateTime expDate, int status_ID, int totalPoint, string accessCode, string eMRCode, int eMRPlace_ID, string notes)
    {
        if (!(AuthenticationInfo.Username == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoUsername"] && AuthenticationInfo.Password == System.Configuration.ConfigurationManager.AppSettings["AuthenticationInfoPassword"]))
            throw new System.Security.Authentication.AuthenticationException();
